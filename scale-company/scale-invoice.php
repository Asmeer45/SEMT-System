...
<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $query = "INSERT INTO weight_scales_invoice (repair_request_id, invoice_date, amount, invoice_attachment, remarks) 
...
<div class="form-container">
    <h2>Invoice Form</h2>
    <form action="scale-invoice.php" method="post" enctype="multipart/form-data">
