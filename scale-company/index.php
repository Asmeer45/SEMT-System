...
$query = "SELECT status, COUNT(*) as count FROM weight_scales_requests GROUP BY status";
...
$sql = "SELECT id, serial_number, service_type, request_date, priority, model, description, status, station_name, platform_number FROM weight_scales_requests 
WHERE status = 'pending'";
$result1 = $conn->query($sql);

$sql1 = "SELECT f.id, f.serial_number, f.service_type, f.request_date, f.priority, f.model, f.description, f.status, f.station_name, f.platform_number,
...
$sql2 = "SELECT f.id, f.serial_number, f.service_type, f.request_date, f.priority, f.model, f.description, f.status, f.station_name, 
