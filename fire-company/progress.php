...
<body>
    ...
    $sql = "SELECT f.id, f.serial_number, f.service_type, f.request_date, f.priority, f.type, f.description, f.status, f.station_name, f.platform_number,
     o.quotation_attachment FROM fire_extinguishers_requests f 
...
$quotation_sql = "SELECT repair_request_id FROM fire_extinguishers_invoice";
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '    <td >
                                    ...
                                    <a href="fire-invoice.php?request_id=' . $row['id'] . '">
