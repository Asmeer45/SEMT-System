...
<body>
<?php
    // Ensure correct file inclusion paths
    $base_path = __DIR__;

    include($base_path . '/include/header.php');
    include($base_path . '/../include/config.php');

    // Check if request_id is set in URL
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $query = "INSERT INTO fire_extinguishers_invoice (repair_request_id, invoice_date, amount, invoice_attachment, remarks) 
...
<div class="form-container">
    <h2>Invoice Form</h2>
    <form action="fire-invoice.php" method="post" enctype="multipart/form-data">
    ...
    <input type="text" id="request-id" name="request_id" value="<?php echo htmlspecialchars($request_id); ?>" readonly>
        ...
        <button class="button1"><a href="progress.php"> Back </a></button>
    </form>
</div>
