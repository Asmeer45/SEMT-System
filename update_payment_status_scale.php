...
if (isset($_GET['id'])) {
    ...
    try {
        ...
        $queryFetch = "SELECT repair_request_id FROM weight_scales_quotations WHERE id = ?";
        ...
        if ($repair_request_id || $id) {
            ...
            $query1 = "UPDATE weight_scales_quotations SET payment_status = 'In Progress' WHERE id = ?";
            ...
            $query2 = "UPDATE weight_scales_requests SET status = 'In Progress' WHERE id = ?";
